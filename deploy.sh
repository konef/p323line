...
if [ "$a" -eq 0 ] && [ "$b" -eq 0 ] 
then
  [ -f $home_dir/backup/helloworld-ws.war_old_v2 ] && sudo rm -rf $home_dir/backup/helloworld-ws.war_old_v2
  echo "OK. $a,$b"
  exit 0
else
  if [ -f $home_dir/backup/helloworld-ws.war_old ]
  ...
  [ -f $home_dir/backup/helloworld-ws.war_old_v2 ] && sudo mv $home_dir/backup/helloworld-ws.war_old_v2 $home_dir/backup/helloworld-ws.war_old
